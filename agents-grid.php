...
<div class="click-closed"></div>
  ...
  <nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
    <div class="container">
      ...
      <a class="navbar-brand text-brand" href="index.php">Property<span class="color-b">Lime</span></a>
        ...
        <div class="col-sm-12 col-md-4">
          <div class="widget-a">
            <div class="w-header-a">
              <h3 class="w-title-a text-brand">PropertyLime</h3>
            </div>
            <div class="w-body-a">
              <p class="w-text-a color-text-a">
                Providing a seamless home rental experience to tenants, agents.
              </p>
            </div>
        ...
        <div class="col-md-12">
          ...
          <div class="copyright-footer">
            <p class="copyright color-text-a">
              &copy; Copyright
              <span class="color-a">PropertyLime</span> All Rights Reserved.
            </p>
          </div>
          <div class="credits">           
            Designed by Angelo Labrador</a>
          </div>
        </div>
      </div>
    </div>
